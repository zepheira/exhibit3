...
define([
    ...
    "gmaps2"
], function($, Exhibit, MapExtension, Marker, Debug, Set, AccessorsUtilities, SettingsUtilities, ViewUtilities, ExpressionParser, UIContext, View, Coordinator, Coder, DefaultColorCoder) {
/**
 * @class
 * @constructor
 ...
 */
GoogleMaps2View = function(containerElmt, uiContext) {
    GoogleMaps2View._initialize();
    ...
    this.addSettingSpecs(GoogleMaps2View._settingSpecs);
 ...
 * @constant
 */
GoogleMaps2View._accessorSpecs = [
 ...
 *
 */
GoogleMaps2View._initialize = function() {
 ...
 */
GoogleMaps2View.create = function(configuration, containerElmt, uiContext) {
    var view = new GoogleMaps2View(
        containerElmt,
        UIContext.create(configuration, uiContext)
    );
    GoogleMaps2View._configure(view, configuration);
 ...
 * @returns {Exhibit.GoogleMaps2View}
 */
GoogleMaps2View.createFromDOM = function(configElmt, containerElmt, uiContext) {
    var configuration, view;
    configuration = Exhibit.getConfigurationFromDOM(configElmt);
    view = new GoogleMaps2View(
        containerElmt !== null ? containerElmt : configElmt, 
        UIContext.createFromDOM(configElmt, uiContext)
    );
    
    AccessorsUtilities.createAccessorsFromDOM(configElmt, GoogleMaps2View._accessorSpecs, view._accessors);
 ...
 * @param {Object} configuration
 */
GoogleMaps2View._configure = function(view, configuration) {
    var accessors;
    AccessorsUtilities.createAccessors(configuration, GoogleMaps2View._accessorSpecs, view._accessors);
 ...
 */
GoogleMaps2View.lookupLatLng = function(set, addressExpressionString, outputProperty, outputTextArea, database, accuracy) {
 ...
 *
 */
GoogleMaps2View.prototype.dispose = function() {
    var view = this;
 ...
 * @private
 */
GoogleMaps2View.prototype._internalValidate = function() {
 ...
 * @private
 */
GoogleMaps2View.prototype._initializeUI = function() {
 ...
 * @returns {GMap2}
 */
GoogleMaps2View.prototype._constructGMap = function(mapDiv) {
 ...
 * @returns {Function}
 */
GoogleMaps2View.prototype._createColorMarkerGenerator = function() {
 ...
 * @returns {Function}
 */
GoogleMaps2View.prototype._createSizeMarkerGenerator = function() {
 ...
 * @returns {Function}
 */
GoogleMaps2View.prototype._createIconMarkerGenerator = function() {
 ...
 * @private
 */
GoogleMaps2View.prototype._reconstruct = function() {
 ...
 */
GoogleMaps2View.prototype._rePlotItems = function(unplottableItems) {
 ...
 * @returns {GPolygon}
 */
GoogleMaps2View.prototype._plotPolygon = function(itemID, polygonString, color, makeLatLng) {
 ...
 * @returns {GPolyline}
 */
GoogleMaps2View.prototype._plotPolyline = function(itemID, polylineString, color, makeLatLng) {
 ...
 */
GoogleMaps2View.prototype._addPolygonOrPolyline = function(itemID, poly) {
    var self = this;
 ...
 * @returns {Array}
 */
GoogleMaps2View.prototype._parsePolygonOrPolyline = function(s, makeLatLng) {
    var coords, a, i, pair;
    coords = [];
 ...
 */
GoogleMaps2View.prototype._select = function(selection) {
    var itemID, marker;
 ...
 * @returns {Element} 
 */
GoogleMaps2View.prototype._createInfoWindow = function(items) {
 ...
 * @returns {GMarker}
 */
GoogleMaps2View.markerToMap = function(marker, position) {
 ...
 */
GoogleMaps2View.prototype.updateMarkerIcon = function(key, iconURL) {
    var cached;
 ...
 * @returns {GMarker}
 */
GoogleMaps2View.prototype._makeMarker = function(position, shape, color, iconSize, iconURL, label, settings) {
    ...
    if (typeof cached !== "undefined" && (cached.settings === settings)) {
	    gmarker = GoogleMaps2View.markerToMap(cached, position);
    } else {
        marker = Marker.makeMarker(shape, color, iconSize, iconURL, label, settings, this);
        gmarker = GoogleMaps2View.markerToMap(marker, position);
